document.addEventListener("DOMContentLoaded", () => {
    ...
    const produtos = [
        {
            id: 1,
            nome: "Camiseta Polo Levi's",
            categoria: "blusas",
            preco: 59.00,
            imagem:
                "./assets/masculina-blusa.jpeg",
            descricao: "Camiseta Masculina Levi's Gola Polo Azul Marinho",

        },
        {
            id: 2,
            nome: "Camiseta Soldier Preta",
            categoria: "blusas",
            preco: 90.00,
            imagem:
                "./assets/masculina-blusa2.jpeg",
            descricao: "Camiseta Masculina Soldier Preta Bélica ",
        },
        {
            id: 3,
            nome: "Calça Jeans",
            ...
            preco: 150.00,
            imagem:
                "./assets/calça-masculina1.jpeg",
            descricao: "Calça Masculina Jeans Junior Confort Rasgada",
        },
        {
            id: 4,
            nome: "Shorts Masculino",
            categoria: "shorts",
            preco: 30.00,
            imagem:
                "./assets/shots-masculino.jpeg",
            descricao: "Shorts Masculino Confortável e Estiloso",
        },
       
        {
            ...
            preco: 99.99,
            imagem:
                "./assets/relogio-masculino.jpeg",
            descricao: "Relógio Dourado Masculino Mondaine",
        },

        {
            ...
            preco: 99.99,
            imagem:
                "./assets/sapato-masculino.jpeg",
            descricao: "Sapato Masculino Casual Castelli Marinho",
        },
